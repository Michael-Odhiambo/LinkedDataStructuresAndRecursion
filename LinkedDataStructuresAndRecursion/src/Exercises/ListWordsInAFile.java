 ...
 * The list can be written to a file.
 */
public class ListWordsInAFile {
    ...
    public static void main( String[] args ) {
        ...
        try {
            ...
            while ( word != null ) {
                word = word.toLowerCase();  // Covert word to lower case.
            ...
            System.out.println( "Number different words found in file: " + wordList.size() );
            System.out.println();
    ...
    /**
     * Sorts a list of strings into lexicographical order, using selection sort and
     * treating the list much like an array. In this program, the list only contains words
     * made up of lower case letters, so lexicographic order is the same as alphabetical order.
     */
